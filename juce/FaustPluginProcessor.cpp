/* ------------------------------------------------------------
author: "Evermind"
name: "reverbtrickery", "Reverb Trickery"
...
class mydsp : public base_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "reverbtrickery.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst3 = (0.0500000007f * fConst0);
		fConst4 = (20.0f / fConst0);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow2 = (0.00499999989f * fSlow0);
		int iSlow3 = (float(fCheckbox0) <= 0.0f);
		float fSlow4 = (0.00100000005f * float(fHslider1));
		float fSlow5 = (0.00100000005f * float(fHslider2));
		float fSlow6 = std::min<float>(fSlow4, fSlow5);
		int iSlow7 = (std::fabs(fSlow6) < 1.1920929e-07f);
		float fSlow8 = (iSlow7 ? 0.0f : std::exp((0.0f - (fConst1 / (iSlow7 ? 1.0f : fSlow6)))));
		int iSlow9 = (float(fCheckbox1) <= 0.0f);
		float fSlow10 = std::tan((fConst2 * float(fHslider3)));
		float fSlow11 = (1.0f / fSlow10);
		float fSlow12 = (1.0f / (((fSlow11 + 1.0f) / fSlow10) + 1.0f));
		int iSlow13 = (float(fCheckbox2) <= 0.0f);
		float fSlow14 = std::pow(10.0f, (0.0199999996f * float(fHslider4)));
		int iSlow15 = (float(fCheckbox3) <= 0.0f);
		float fSlow16 = std::pow(2.0f, (0.0833333358f * (12.0f - (24.0f * float(fHslider5)))));
		float fSlow17 = std::tan((fConst2 * float(fHslider6)));
		float fSlow18 = (1.0f / fSlow17);
		float fSlow19 = (1.0f / (((fSlow18 + 1.0f) / fSlow17) + 1.0f));
		float fSlow20 = (1.0f - ((1.0f - fSlow18) / fSlow17));
		float fSlow21 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow17))));
		float fSlow22 = (1.0f - ((1.0f - fSlow11) / fSlow10));
		float fSlow23 = (2.0f * (1.0f - (1.0f / mydsp_faustpower2_f(fSlow10))));
		float fSlow24 = (1.0f - fSlow8);
		float fSlow25 = std::pow(10.0f, (0.0500000007f * float(fHslider7)));
		int iSlow26 = int((fConst5 * float(fHslider8)));
		int iSlow27 = (std::fabs(fSlow4) < 1.1920929e-07f);
		float fSlow28 = (iSlow27 ? 0.0f : std::exp((0.0f - (fConst1 / (iSlow27 ? 1.0f : fSlow4)))));
		int iSlow29 = (std::fabs(fSlow5) < 1.1920929e-07f);
		float fSlow30 = (iSlow29 ? 0.0f : std::exp((0.0f - (fConst1 / (iSlow29 ? 1.0f : fSlow5)))));
		float fSlow31 = float(fHslider9);
		float fSlow32 = (0.00999999978f * fSlow31);
		float fSlow33 = (9.99999975e-05f * (fSlow31 * (100.0f - float(fHslider10))));
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			float fTemp0 = float(input0[i0]);
			float fTemp1 = (iSlow15 ? 0.0f : fTemp0);
			fVec0[(IOTA & 131071)] = fTemp1;
			fRec16[0] = std::fmod((fConst3 + ((fRec16[1] + 1.0f) - fSlow16)), fConst3);
			int iTemp2 = int(fRec16[0]);
			int iTemp3 = std::min<int>(65537, std::max<int>(0, iTemp2));
			float fTemp4 = std::floor(fRec16[0]);
			float fTemp5 = (1.0f - fRec16[0]);
			float fTemp6 = (fTemp4 + fTemp5);
			float fTemp7 = (fRec16[0] - fTemp4);
			int iTemp8 = std::min<int>(65537, std::max<int>(0, (iTemp2 + 1)));
			float fTemp9 = std::min<float>((fConst4 * fRec16[0]), 1.0f);
			float fTemp10 = (fConst3 + fRec16[0]);
			int iTemp11 = int(fTemp10);
			int iTemp12 = std::min<int>(65537, std::max<int>(0, iTemp11));
			float fTemp13 = std::floor(fTemp10);
			float fTemp14 = ((fTemp13 + fTemp5) - fConst3);
			float fTemp15 = (fConst3 + (fRec16[0] - fTemp13));
			int iTemp16 = std::min<int>(65537, std::max<int>(0, (iTemp11 + 1)));
			float fTemp17 = (1.0f - fTemp9);
			float fTemp18 = (iSlow15 ? fTemp0 : ((((fVec0[((IOTA - iTemp3) & 131071)] * fTemp6) + (fTemp7 * fVec0[((IOTA - iTemp8) & 131071)])) * fTemp9) + (((fVec0[((IOTA - iTemp12) & 131071)] * fTemp14) + (fTemp15 * fVec0[((IOTA - iTemp16) & 131071)])) * fTemp17)));
			float fTemp19 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow14 * (iSlow13 ? 0.0f : fTemp18))));
			float fTemp20 = (iSlow13 ? fTemp18 : (fTemp19 * (1.0f - (0.333333343f * mydsp_faustpower2_f(fTemp19)))));
			float fTemp21 = (iSlow9 ? 0.0f : fTemp20);
			fRec17[0] = (fTemp21 - (fSlow19 * ((fSlow20 * fRec17[2]) + (fSlow21 * fRec17[1]))));
			fRec15[0] = (fTemp21 - ((fSlow19 * (fRec17[2] + (fRec17[0] + (2.0f * fRec17[1])))) + (fSlow12 * ((fSlow22 * fRec15[2]) + (fSlow23 * fRec15[1])))));
			float fTemp22 = (iSlow9 ? fTemp20 : (fSlow12 * (fRec15[2] + (fRec15[0] + (2.0f * fRec15[1])))));
			float fTemp23 = (iSlow3 ? 0.0f : fTemp22);
			float fTemp24 = float(input1[i0]);
			float fTemp25 = (iSlow15 ? 0.0f : fTemp24);
			fVec1[(IOTA & 131071)] = fTemp25;
			float fTemp26 = (iSlow15 ? fTemp24 : ((fTemp9 * ((fVec1[((IOTA - iTemp3) & 131071)] * fTemp6) + (fTemp7 * fVec1[((IOTA - iTemp8) & 131071)]))) + (fTemp17 * ((fTemp14 * fVec1[((IOTA - iTemp12) & 131071)]) + (fTemp15 * fVec1[((IOTA - iTemp16) & 131071)])))));
			float fTemp27 = std::max<float>(-1.0f, std::min<float>(1.0f, (fSlow14 * (iSlow13 ? 0.0f : fTemp26))));
			float fTemp28 = (iSlow13 ? fTemp26 : (fTemp27 * (1.0f - (0.333333343f * mydsp_faustpower2_f(fTemp27)))));
			float fTemp29 = (iSlow9 ? 0.0f : fTemp28);
			fRec19[0] = (fTemp29 - (fSlow19 * ((fSlow20 * fRec19[2]) + (fSlow21 * fRec19[1]))));
			fRec18[0] = (fTemp29 - ((fSlow19 * (fRec19[2] + (fRec19[0] + (2.0f * fRec19[1])))) + (fSlow12 * ((fSlow22 * fRec18[2]) + (fSlow23 * fRec18[1])))));
			float fTemp30 = (iSlow9 ? fTemp28 : (fSlow12 * (fRec18[2] + (fRec18[0] + (2.0f * fRec18[1])))));
			float fTemp31 = (iSlow3 ? 0.0f : fTemp30);
			fRec14[0] = ((fRec14[1] * fSlow8) + (std::fabs((std::fabs(fTemp23) + std::fabs(fTemp31))) * fSlow24));
			float fRec13 = fRec14[0];
			int iTemp32 = (fRec13 > fSlow25);
			iVec2[0] = iTemp32;
			iRec20[0] = std::max<int>(int((iSlow26 * (iTemp32 < iVec2[1]))), int((iRec20[1] + -1)));
			float fTemp33 = std::fabs(std::max<float>(float(iTemp32), float((iRec20[0] > 0))));
			float fTemp34 = ((fRec11[1] > fTemp33) ? fSlow30 : fSlow28);
			fRec12[0] = ((fRec12[1] * fTemp34) + (fTemp33 * (1.0f - fTemp34)));
			fRec11[0] = fRec12[0];
			fRec10[0] = ((0.000500000024f * fRec10[2]) + (0.499749988f * ((iSlow3 ? fTemp22 : (fRec11[0] * fTemp23)) + (iSlow3 ? fTemp30 : (fRec11[0] * fTemp31)))));
			float fTemp35 = (fRec10[0] - (0.75f * fRec8[1]));
			fVec3[(IOTA & 255)] = fTemp35;
			fRec8[0] = fVec3[((IOTA - 142) & 255)];
			float fRec9 = (0.75f * fTemp35);
			float fTemp36 = ((fRec9 + fRec8[1]) - (0.75f * fRec6[1]));
			fVec4[(IOTA & 127)] = fTemp36;
			fRec6[0] = fVec4[((IOTA - 107) & 127)];
			float fRec7 = (0.75f * fTemp36);
			float fTemp37 = ((fRec7 + fRec6[1]) - (0.625f * fRec4[1]));
			fVec5[(IOTA & 511)] = fTemp37;
			fRec4[0] = fVec5[((IOTA - 379) & 511)];
			float fRec5 = (0.625f * fTemp37);
			float fTemp38 = ((fRec5 + fRec4[1]) - (0.625f * fRec2[1]));
			fVec6[(IOTA & 511)] = fTemp38;
			fRec2[0] = fVec6[((IOTA - 277) & 511)];
			float fRec3 = (0.625f * fTemp38);
			float fTemp39 = (fRec3 + fRec2[1]);
			float fTemp40 = ((0.699999988f * fRec24[1]) + fRec1[1]);
			fVec7[(IOTA & 1023)] = fTemp40;
			fRec24[0] = fVec7[((IOTA - 908) & 1023)];
			float fRec25 = (0.0f - (0.699999988f * fTemp40));
			fVec8[(IOTA & 8191)] = (fRec25 + fRec24[1]);
			fRec23[0] = ((0.000500000024f * fRec23[1]) + (0.999499977f * fVec8[((IOTA - 4217) & 8191)]));
			float fTemp41 = ((fSlow32 * fRec23[0]) - (0.5f * fRec21[1]));
			fVec9[(IOTA & 4095)] = fTemp41;
			fRec21[0] = fVec9[((IOTA - 2656) & 4095)];
			float fRec22 = (0.5f * fTemp41);
			fVec10[(IOTA & 4095)] = (fRec22 + fRec21[1]);
			fRec0[0] = (fTemp39 + (fSlow32 * fVec10[((IOTA - 2656) & 4095)]));
			float fTemp42 = ((0.699999988f * fRec29[1]) + fRec0[1]);
			fVec11[(IOTA & 1023)] = fTemp42;
			fRec29[0] = fVec11[((IOTA - 672) & 1023)];
			float fRec30 = (0.0f - (0.699999988f * fTemp42));
			fVec12[(IOTA & 8191)] = (fRec30 + fRec29[1]);
			fRec28[0] = ((0.000500000024f * fRec28[1]) + (0.999499977f * fVec12[((IOTA - 4453) & 8191)]));
			float fTemp43 = ((fSlow32 * fRec28[0]) - (0.5f * fRec26[1]));
			fVec13[(IOTA & 2047)] = fTemp43;
			fRec26[0] = fVec13[((IOTA - 1800) & 2047)];
			float fRec27 = (0.5f * fTemp43);
			fVec14[(IOTA & 2047)] = (fRec27 + fRec26[1]);
			fRec1[0] = (fTemp39 + (fSlow32 * fVec14[((IOTA - 1800) & 2047)]));
			float fTemp44 = ((0.699999988f * fRec36[1]) + fRec32[1]);
			fVec15[(IOTA & 1023)] = fTemp44;
			fRec36[0] = fVec15[((IOTA - 908) & 1023)];
			float fRec37 = (0.0f - (0.699999988f * fTemp44));
			fVec16[(IOTA & 8191)] = (fRec37 + fRec36[1]);
			fRec35[0] = ((0.000500000024f * fRec35[1]) + (0.999499977f * fVec16[((IOTA - 4217) & 8191)]));
			float fTemp45 = ((fSlow33 * fRec35[0]) - (0.5f * fRec33[1]));
			fVec17[(IOTA & 4095)] = fTemp45;
			fRec33[0] = fVec17[((IOTA - 2656) & 4095)];
			float fRec34 = (0.5f * fTemp45);
			fVec18[(IOTA & 4095)] = (fRec34 + fRec33[1]);
			fRec31[0] = (fRec2[1] + (fRec3 + (fSlow33 * fVec18[((IOTA - 2656) & 4095)])));
			float fTemp46 = ((0.699999988f * fRec41[1]) + fRec31[1]);
			fVec19[(IOTA & 1023)] = fTemp46;
			fRec41[0] = fVec19[((IOTA - 672) & 1023)];
			float fRec42 = (0.0f - (0.699999988f * fTemp46));
			fVec20[(IOTA & 8191)] = (fRec42 + fRec41[1]);
			fRec40[0] = ((0.000500000024f * fRec40[1]) + (0.999499977f * fVec20[((IOTA - 4453) & 8191)]));
			float fTemp47 = ((fSlow33 * fRec40[0]) - (0.5f * fRec38[1]));
			fVec21[(IOTA & 2047)] = fTemp47;
			fRec38[0] = fVec21[((IOTA - 1800) & 2047)];
			float fRec39 = (0.5f * fTemp47);
			fVec22[(IOTA & 2047)] = (fRec39 + fRec38[1]);
			fRec32[0] = (fTemp39 + (fSlow33 * fVec22[((IOTA - 1800) & 2047)]));
			output0[i0] = FAUSTFLOAT(((fSlow1 * fTemp0) + (fSlow2 * (fRec1[0] + (fRec31[0] + fRec0[0])))));
			output1[i0] = FAUSTFLOAT(((fSlow1 * fTemp24) + (fSlow2 * ((fRec0[0] + fRec1[0]) + fRec32[0]))));
			IOTA = (IOTA + 1);
			fRec16[1] = fRec16[0];
			fRec17[2] = fRec17[1];
			fRec17[1] = fRec17[0];
	...
	#define FAUST_FILE_NAME "reverbtrickery.dsp"
